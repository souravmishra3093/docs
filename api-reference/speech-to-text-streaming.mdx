...
- Example: `hi` <br />
- Refer to section [Language Codes](/usage-guides/speech-to-text-streaming#supported-languages) for valid language code.
</ParamField>  
...
- Example: `generic` <br />
- Refer to section [Domains](/usage-guides/speech-to-text-streaming#supported-domains) for valid domain code.
</ParamField> 
...
- Refer to section [Supported Audio Formats](/usage-guides/speech-to-text-streaming#supported-audio-formats) for valid audio format code. <br />
...
- Refer to section [API Codes](/usage-guides/speech-to-text-streaming#api-messages) to view the list of messages/ cause and its description.
...
In the API response, if the `success` = `false`, then the cause will display the reason for the error. Refer to [API Codes](/usage-guides/speech-to-text-streaming#api-messages) 
