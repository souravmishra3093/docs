...
### Non-SDK Code Example

If you would like to try out making a Reverie speech-to-text request in a specific language,
we offer a library of code-samples in our Github repo. However, we recommend first trying out our SDKs.

- [Python Sample Code](https://github.com/reverieinc/python-sdk/tree/main/stt-stream)
- [JavaScript Sample Code](https://github.com/reverieinc/javascript-sdk/tree/main/stt-stream)
- [GoLang Sample Code](https://github.com/reverieinc/golang-sdk/tree/main/stt-stream)
...
| E-commerce   | Tailored for E-commerce and FMCG-specific terms.                 |
